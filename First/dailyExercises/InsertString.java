...
public class InsertString {
    ...
    public static String insertString(String originalString, String stringToBeInserted, int var) {
        // Create a new string
        String newString = originalString.substring(0, var + 1) + stringToBeInserted + originalString.substring(var + 1);
        return newString;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("String to be inserted at index: " + var);
        // Insert the String
        System.out.println("Modified String: " + insertString(originalString, stringToBeInserted, var));
    }
}
